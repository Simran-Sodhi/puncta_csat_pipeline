...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help="Nucleus channel index in the input image (default: 2 = third channel)",
    )
    parser.add_argument(
        "--z-index",
        type=int,
    ...
    for img_path in image_paths:
        ...
        try:
            ...
            masks = postprocess_mask(masks,min_size=args.min_size, remove_edges=True)
            # filter_small_objects(masks, min_size=args.min_size)
